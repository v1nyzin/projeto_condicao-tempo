...
form === null || form === void 0 ? void 0 : form.addEventListener("submit", (Event) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    try {
        const resposta = yield fetch(`https://api.openweathermap.org/data/2.5/weather?q=${localizacao}&appid=71d5cdf2c7f8eef85a28d2766510f728&appid=pt_br&units=metric`);
